...
<div class="flex md:order-2 space-x-3">
    ...
    <div class="sm:flex sm:items-center sm:ml-6">
        ...
        <a href="{{route('profile.overview')}}" class="flex items-center">
            <img id="avatarButton" type="button" data-dropdown-toggle="userDropdown" data-dropdown-placement="bottom-start" class="w-10 h-10 rounded-full cursor-pointer" src="{{ asset('img/upload/profile/'.Auth::user()->image_profile_path)}}" alt="User dropdown">
