...
<div class="inline-block my-4">
    <div class="border border-strokeColor w-donator-card clearfix p-4 rounded-xl">
        ...
        <div class="float-left w-donator-img h-donator-img bg-white shadow rounded-lg">
            <img src="/img/upload/profile/{{$campcashdonor['donor'] != null ? $campcashdonor['donor']->image_profile_path : 'default_profile.png'}}" alt="">
        </div>
        ...
        <div class="h-donator-img pl-5 flex flex-wrap content-between">
            {{-- name --}}
            <div class="w-full">
                <p class="text-primaryTextColor font-bold text-2xl line-clamp-1">
                    {{$campcashdonor['donor'] != null ? $campcashdonor['donor']->name : 'Anonymous'}}
                </p>
                <div class="pt-2"></div>
                <p class="">
