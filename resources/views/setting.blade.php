...
<body>
    <div class="mx-5 sm:mx-32 mt-10 mb-16">
        <div class=" border shadow-md px-8 py-4 sm:py-6 mt-8 rounded">
            <i class="fa-sharp fa-solid fa-globe fa-xl"></i>
            <span class="font-bold ml-3 text-xl">Language</span>
            <h6 class="my-4">Choose your preferred language to be displayed on</h6>
            <div class="w-full md:w-2/3 sm:my-4">
        ...
        <div class=" border shadow-md px-8 py-4 sm:py-6 mt-8 rounded">
            ...
            <h6 class="my-4">Customize where you want to receive your notifications</h6>
            <div class="w-full md:w-1/2 sm:my-4">
                <label class="flex items-center">
                    <input id="notification"
                        class="relative w-10 h-5 transition-all duration-200 ease-in-out bg-gray-300 rounded-full shadow-inner outline-none appearance-none "
            ...
            <p class="text-[#ff4238]">*Important account and content notifications may still be sent to you, even if
                your preferred notification settings are in place.</p>
        </div>
    </div>
</body>
