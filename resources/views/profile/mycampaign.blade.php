    ...
    @foreach ($my_campaigns as $my_campaign)
        ...
        <div class="border bg-white rounded-lg shadow-lg flex flex-col md:flex-row ">
            ...
            <div class="flex flex-col justify-between p-4 md:w-1/2">
                <div>
                    <h3 class="text-2xl font-bold mb-2">{{$my_campaign->title}}</h3>
                    <p class="text-gray-600 mb-2"><span class="line-clamp-3">{{$my_campaign->summary}}</span></p>
                </div>
                <button type="button"
