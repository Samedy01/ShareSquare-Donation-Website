        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
            ...
            <div class="bg-white">
                <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
                    <div class="mb-6">
                        <a href="{{ route('campaign_categories.create') }}" class="px-4 py-2 bg-blue-500 text-white rounded-md">Add New Category</a>
                    </div>
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach ($campaignCategories as $category)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href="{{ route('campaign_categories.edit', $category) }}" class="text-blue-500">Edit</a>
                                    <form class="inline-block" action="{{ route('campaign_categories.destroy', $category) }}" method="POST" onsubmit="return confirm('Are you sure?')">
                                        @csrf
                                        @method('DELETE')
