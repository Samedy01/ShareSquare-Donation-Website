    ...
    <div class=" col-span-3 max-h-[88vh] overflow-auto right-side pr-2 pl-2">
            ...
            <div class="mt-4 " id="campaign_option_form">
                ...
                <label for="donating"
                    ...
                    <input type="radio" class="hidden" id="donating" name="campaign_type" value="donating"
                           data-target-open="#donate_option_form,#delivery_option_form">
                </label>
                <label for="raising"
                       class="mt-3 flex w-[60%] py-3 px-5 rounded shadow-sm border  hover:border-red-500 campaign_type hover:cursor-pointer">
                    <img
        ...
        <div class="mb-[100px] hidden form" id="form_step_4">
            ...
            <div class="mt-4">
                ...
                <label for="telegram_username" class="">
                    <input name="telegram_username" placeholder="Contact title (Ex: Instagram)" type="text"
                           id="telegram_username"
                           class="border py-5 px-7 rounded-[10px] mt-3 focus:outline-none focus:ring-1 focus:ring-red-200 focus:border-transparent w-full">
                </label>
                <label for="telegram_username" class="">
                    <input name="telegram_username" placeholder="Enter contact link" type="text"
                           id="telegram_username"
                           class="border py-5 px-7 rounded-[10px] mt-3 focus:outline-none focus:ring-1 focus:ring-red-200 focus:border-transparent w-full">
                </label>
                <a href="#" class="primary-color-letter mt-3 block">
