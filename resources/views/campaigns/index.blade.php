...
<body class="container border mx-auto">
    ...
    <div class="md:mt-[5rem] flex mt-[6rem]">
        <div class="mx-auto md:w-[50%] border rounded-[10px] md:p-5 p-2">
            <div class="flex justify-between">
                <div class="md:text-xl">Your filter</div>
                <a href="#" class="primary-color-letter md:text-xl">Clear</a>
            </div>
                ...
                <div class="border-r md:p-3 p-1 col-span-2">
                    ...
                    <div class="mt-3 text-sm md:text-base">
                        <label class="flex items-center mb-1 hover:cursor-pointer">
                            ...
                            <span class="md:ml-5 ml-1 text-gray-700">Education</span>
                        </label>
                        <label class="flex items-center mb-1 hover:cursor-pointer">
                            <input type="checkbox" class="hidden">
                            <span class="w-5 h-5 border-2 border-gray-200 rounded bg-white flex items-center justify-center transition-colors duration-200">
                            ...
                            <span class="md:ml-5 ml-1 text-gray-700">Medical</span>
                        </label>
    ...
    <div class="md:w-3/4 mx-auto">
        ...
        <div class="grid grid-cols-1 grid sm:grid-cols-1 md:grid-cols-1 lg:grid-cols-1 xl:grid-cols-1 items-center justify-between w-full gap-5 md:gap-5 lg:gap-5 mb-5">
                        ...
                        <div class="flex flex-wrap justify-between gap-3">
                            <div class=" inline-flex" role="group">
                                ...
                                <button type="button"
                                    ...
                                    <svg aria-hidden="true" class="md:w-4 md:h-4 w-3 mr-1 fill-current" fill="currentColor"
                                         xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">

                                        <path
                                            d="M464 256A208 208 0 1 1 48 256a208 208 0 1 1 416 0zM0 256a256 256 0 1 0 512 0A256 256 0 1 0 0 256zM232 120V256c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2V120c0-13.3-10.7-24-24-24s-24 10.7-24 24z" />
                                    </svg>
                                    <span class="font-bold mr-1">36</span>
                ...
                <div class="border bg-white rounded-lg shadow-lg flex flex-col md:flex-row inline-block">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <span class="inline-block mb-2">
                                <span
                                    class="bg-mainColor text-mainColor text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded border border-secondaryColor">
                                    <svg class="w-5 h-5 mr-2" viewBox="0 0 30 31" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="flex flex-wrap justify-between gap-3">
                            ...
                            <div class="inline-flex w-full" role="group">
                                <button class="px-8 py-3 border rounded-xl bg-red-500 hover:bg-red-700 text-white w-full md:w-1/2 lg:w-1/2 disabled:bg-secondaryColor" disabled>Donate Now</button>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <a href="{{route('campaigns.show', ['campaign_id'=>$campaign->id])}}" class="flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100  md:flex-row hover:drop-shadow-xl transition">
                ...
                <div class="border bg-white rounded-lg shadow-lg flex flex-col md:flex-row inline-block">
                    ...
                    <div
                        ...
                        <div>
                            ...
                            <p class="campaign-theme text-gray-500 mb-2">Static</p>
                            <span class="inline-block mb-2">
                                <span
                                    class="bg-secondaryColor text-mainColor text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded border border-secondaryColor">
                                    <svg aria-hidden="true" class="w-3 h-3 mr-1" fill="currentColor"
